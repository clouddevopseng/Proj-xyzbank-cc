...
<html>
    ...
    <body>
        <h1>Congratulations!</h1> You have successfully created a Brutusin-RPC war application Great achievement</h1>
    <div>The functional testing module is accessible and working as expected <a href="rpc/repo">here</a></div>
</body>
</html>
